import { ArrowRight, DollarSign, Lock, Zap } from 'lucide-react';
...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-screen flex items-center">
      {/* Animated background */}
      <div className="absolute inset-0 bg-linear-to-br from-emerald-50 via-teal-50 to-cyan-50">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up animation-delay-400">
            <button
              ...
              className="group relative inline-flex items-center px-8 py-4 bg-linear-to-r from-emerald-600 to-teal-600 text-white text-lg font-bold rounded-full overflow-hidden transition-all duration-300 hover:scale-105"
            >
